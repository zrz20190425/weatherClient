 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http:/service.tomtone.com/", wsdlLocation = "http://192.168.1.10/service/service.asmx?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http:/service.tomtone.com/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.10/service/service.asmx?wsdl");
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("http:/service.tomtone.com/", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http:/service.tomtone.com/", "ServiceSoap"), ServiceSoap.class, features);
    }
